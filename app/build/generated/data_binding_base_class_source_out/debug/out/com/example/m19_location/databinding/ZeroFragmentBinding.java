...
public final class ZeroFragmentBinding implements ViewBinding {
  ...
  private ZeroFragmentBinding(@NonNull ConstraintLayout rootView, @NonNull Button button,
      @NonNull Button buttonMap, @NonNull ConstraintLayout fragmentZero,
      @NonNull ImageView imagePreview, @NonNull PreviewView viewFinder) {
  ...
  public static ZeroFragmentBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ZeroFragmentBinding((ConstraintLayout) rootView, button, buttonMap, fragmentZero,
