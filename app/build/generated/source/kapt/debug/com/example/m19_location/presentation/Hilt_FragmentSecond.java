 ...
 */
public abstract class Hilt_FragmentSecond extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FragmentSecond(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FragmentSecond_GeneratedInjector) this.generatedComponent()).injectFragmentSecond(UnsafeCasts.<FragmentSecond>unsafeCast(this));
    }
  }
