 ...
 */
public abstract class Hilt_FragmentZero extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FragmentZero(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FragmentZero_GeneratedInjector) this.generatedComponent()).injectFragmentZero(UnsafeCasts.<FragmentZero>unsafeCast(this));
    }
  }
