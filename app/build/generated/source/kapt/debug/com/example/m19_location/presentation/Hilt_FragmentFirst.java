 ...
 */
public abstract class Hilt_FragmentFirst extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FragmentFirst(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FragmentFirst_GeneratedInjector) this.generatedComponent()).injectFragmentFirst(UnsafeCasts.<FragmentFirst>unsafeCast(this));
    }
  }
